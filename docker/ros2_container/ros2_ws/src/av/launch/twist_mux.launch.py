...
def generate_launch_description():
    twist_mux_config_file_path = os.path.join(get_package_share_directory('av'),
                                              'config', 'teleop_twist_joy.yaml')
    joy_config_file_path = os.path.join(get_package_share_directory('av'),
                                'config', 'teist_mux.yaml')
    ...
    declare_joy_vel = DeclareLaunchArgument(
        'joy_vel', default_value='/av/cmd_vel')
    ...
    declare_config_filepath = DeclareLaunchArgument('config_filepath', default_value=[
        ...
        joy_config, TextSubstitution(text='.teleop_twist_joy.yaml')])
